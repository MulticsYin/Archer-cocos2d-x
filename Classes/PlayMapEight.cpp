...
PlayMapEight::~PlayMapEight() {

}

void PlayMapEight::onEnter() {
	Layer::onEnter();
	...
	contactListener->onContactBegin = CC_CALLBACK_1(PlayMapEight::onContactBegin, this);
	contactListener->onContactPostSolve = CC_CALLBACK_2(PlayMapEight::onContactPostSolve, this);
	contactListener->onContactPreSolve = CC_CALLBACK_2(PlayMapEight::onContactPreSolve, this);
	contactListener->onContactSeparate = CC_CALLBACK_1(PlayMapEight::onContactSeparate, this);
	//事件分发器
	...
	//map00瓦片地图地图
	tilemap = TMXTiledMap::create("map/map8.tmx");
...
// 设置准确位置，放置怪兽；
	auto printM0 = objects->getObject("monster0");
	//	CCASSERT(!printM1.empty(), "SpawnPoint object not found");
	int x0 = printM0["x"].asInt();
	int y0 = printM0["y"].asInt();
	//	auto _player = Sprite::create("orangetriangle.png");
	auto player0 = MonsterD::create();
	//player1->initWithFile("orangetriangle.png");
	player0->setAnchorPoint(Point(0, 1));
	player0->setPosition(x0, y0);
	player0->getPhysicsBody()->setContactTestBitmask(MONSTER1_BIT_MASK);
	addChild(player0);
	...
	auto printM8 = objects->getObject("monster8");
	...
	auto printM9 = objects->getObject("monster9");
	//	CCASSERT(!printM3.empty(), "SpawnPoint object not found");
	...
	auto printM10 = objects->getObject("monster10");
	//	CCASSERT(!printM4.empty(), "SpawnPoint object not found");
	...
	auto printM11 = objects->getObject("monster11");
	//	CCASSERT(!printM5.empty(), "SpawnPoint object not found");
	int x11 = printM11["x"].asInt();
	int y11 = printM11["y"].asInt();
	//	auto _player = Sprite::create("orangetriangle.png");
	auto player11 = MonsterD::create();
	//player2->initWithFile("orangetriangle.png");
	...
	auto printM12 = objects->getObject("monster12");
	//	CCASSERT(!printM5.empty(), "SpawnPoint object not found");
	int x12 = printM11["x"].asInt();
	int y12 = printM11["y"].asInt();
//	//	auto _player = Sprite::create("orangetriangle.png");
	auto player12 = MonsterB::create();
//	//player2->initWithFile("orangetriangle.png");
	player12->setAnchorPoint(Point(0, 1));
	player12->setPosition(x12, y12);
	player12->getPhysicsBody()->setContactTestBitmask(MONSTER1_BIT_MASK);
	addChild(player12);
	//setViewPointCenter(_player->getPosition());
...
void PlayMapEight::update(float time) {

}

void PlayMapEight::onExit() {
	Layer::onExit();
...
bool PlayMapEight::onContactBegin(PhysicsContact &contact) {
...
bool PlayMapEight::onContactPreSolve(PhysicsContact& contact, PhysicsContactPreSolve& solve) {
	return true;
}

void PlayMapEight::onContactPostSolve(PhysicsContact& contact, const PhysicsContactPostSolve& solve) {

}

void PlayMapEight::onContactSeparate(PhysicsContact& contact) {

}

void PlayMapEight::makePhysicsObjAt(Point p, Size size, bool d, float r, float f, float dens, float rest,int gid,int tag)
{
