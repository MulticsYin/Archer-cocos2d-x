...
PlayMapFive::~PlayMapFive() {

}

void PlayMapFive::onEnter() {
	Layer::onEnter();
	...
	contactListener->onContactBegin = CC_CALLBACK_1(PlayMapFive::onContactBegin, this);
	contactListener->onContactPostSolve = CC_CALLBACK_2(PlayMapFive::onContactPostSolve, this);
	contactListener->onContactPreSolve = CC_CALLBACK_2(PlayMapFive::onContactPreSolve, this);
	contactListener->onContactSeparate = CC_CALLBACK_1(PlayMapFive::onContactSeparate, this);
	//事件分发器
	...
	//map00瓦片地图地图
	tilemap = TMXTiledMap::create("map/map5.tmx");
...
void PlayMapFive::update(float time) {

}

void PlayMapFive::onExit() {
	Layer::onExit();
...
bool PlayMapFive::onContactBegin(PhysicsContact &contact) {
...
bool PlayMapFive::onContactPreSolve(PhysicsContact& contact, PhysicsContactPreSolve& solve) {
	return true;
}

void PlayMapFive::onContactPostSolve(PhysicsContact& contact, const PhysicsContactPostSolve& solve) {

}

void PlayMapFive::onContactSeparate(PhysicsContact& contact) {

}

void PlayMapFive::makePhysicsObjAt(Point p, Size size, bool d, float r, float f, float dens, float rest,int gid,int tag)
{
