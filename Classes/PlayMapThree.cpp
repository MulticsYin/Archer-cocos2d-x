...
PlayMapThree::~PlayMapThree() {

}

void PlayMapThree::onEnter() {
	Layer::onEnter();
	...
	contactListener->onContactBegin = CC_CALLBACK_1(PlayMapThree::onContactBegin, this);
	contactListener->onContactPostSolve = CC_CALLBACK_2(PlayMapThree::onContactPostSolve, this);
	contactListener->onContactPreSolve = CC_CALLBACK_2(PlayMapThree::onContactPreSolve, this);
	contactListener->onContactSeparate = CC_CALLBACK_1(PlayMapThree::onContactSeparate, this);
	//事件分发器
	...
	//map00瓦片地图地图
	tilemap = TMXTiledMap::create("map/map3.tmx");
...
void PlayMapThree::update(float time) {

}

void PlayMapThree::onExit() {
	Layer::onExit();
...
bool PlayMapThree::onContactBegin(PhysicsContact &contact) {
...
bool PlayMapThree::onContactPreSolve(PhysicsContact& contact, PhysicsContactPreSolve& solve) {
	return true;
}

void PlayMapThree::onContactPostSolve(PhysicsContact& contact, const PhysicsContactPostSolve& solve) {

}

void PlayMapThree::onContactSeparate(PhysicsContact& contact) {

}

void PlayMapThree::makePhysicsObjAt(Point p, Size size, bool d, float r, float f, float dens, float rest,int gid,int tag)
{
